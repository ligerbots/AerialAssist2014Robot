...
public class RobotMap {
    ...
    public static void init() {
        ...
        try { 
            System.out.println("Init CanJaguar 2 - driveTrainLeftFrontJag");
        ...
        try { 
            System.out.println("Init CanJaguar 3 - driveTrainLeftRearJag");
        ...
        try { 
            System.out.println("Init CanJaguar 5 - driveTrainRightFrontJag");
        ...
        try { 
            System.out.println("Init CanJaguar 6 - driveTrainRightRearJag");
	...
	LiveWindow.addSensor("DriveTrain", "Gyro", driveTrainGyro);
        ...
        shooterSolenoidShoot = new DoubleSolenoid(1, 2);
        shooterKickerSolenoid = new DoubleSolenoid(3, 4);      
	
        
        try { 
            System.out.println("Init CanJaguar 4 - pickupRollerJag");
            pickupRollerJag = new CANJaguar(4);
        } catch (CANTimeoutException ex) {
            System.out.println("************** CANJag 4 FAILED: " + ex.getMessage());
        }
	
        pickupPickupSolenoid = new DoubleSolenoid(5, 6);      
        pickupCatchSolenoid = new DoubleSolenoid(7, 8);      
